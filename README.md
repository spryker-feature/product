...
- [ProductAttributesRestApi ^1.1.0](https://github.com/spryker/product-attributes-rest-api) (Legacy Glue)
...
- [ProductImageSetsBackendApi ^1.1.0](https://github.com/spryker/product-image-sets-backend-api) (Glue Backend)
