...
- [ProductAttributeExtension ^1.1.0](https://github.com/spryker/product-attribute-extension) (Extension)
- [ProductAttributeGuiExtension ^1.0.0](https://github.com/spryker/product-attribute-gui-extension) (Extension)
- [ProductAttributesBackendApi ^1.0.0](https://github.com/spryker/product-attributes-backend-api) (Legacy Glue)
- [ProductAttributesRestApi ^1.2.0](https://github.com/spryker/product-attributes-rest-api) (Legacy Glue)
...
- [ProductImageSetsBackendApi ^1.2.0](https://github.com/spryker/product-image-sets-backend-api) (Glue Backend)
- [ProductImageSetsRestApi ^1.3.0](https://github.com/spryker/product-image-sets-rest-api) (Legacy Glue)
...
- [ProductsRestApi ^2.17.0](https://github.com/spryker/products-rest-api) (Legacy Glue)
